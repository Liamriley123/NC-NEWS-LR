...
describe('/api', () => {
  ...
  describe('/topics', () => {
    ...
    it('will return 405 if any methods are used that are not aloud', () => request.patch('/api/topics').expect(405));
    it('will return 405 if any methods are used that are not aloud', () => request.delete('/api/topics').expect(405));
  });
  ...
  describe('/topics/cats/articles', () => {
    ...
    it('GET should exept querys such as limit to limit number of a page and ?p to choose pagination number', () => request
    ...
    it('GET should exept querys such as ?sort_by and ?order to show us what we want in a specific order', () => request
    ...
    it('GET should exept querys such as ?limit ?p ?sort_by and ?order', () => request
      .get(
    ...
    it('GET 404 due to topic in params doesnt exist', () => request.get('/api/topics/liam/articles').expect(404));
    ...
    it('POST 404 due to topic in params doesnt exist', () => request
  ...
  it('will return 405 if any methods are used that are not aloud', () => request.patch('/api/topics/cats/articles').expect(405));
  it('will return 405 if any methods are used that are not aloud', () => request.delete('/api/topics/cats/articles').expect(405));
  ...
  describe('/articles', () => {
    ...
    it('GET status:200 when nonsense params used it will ignore it and send 200', () => request.get('/api/articles?limit=asdfghjkl').expect(200));
  ...
  describe('/articles/:article_id', () => {
    ...
    it('will return 405 if any methods are used that are not aloud', () => request.post('/api/articles/1').expect(405));
  });
  ...
  describe('/articles/:article_id/comments', () => {
    ...
    it('GET should exept querys such as ?sort_by and ?sort_ascending to show us what we want in a specific order', () => request
    ...
    it('POST 404 due to article_id in params doesnt exist', () => request
      ...
      .expect(404));
    it('will return 405 if any methods are used that are not aloud', () => request.patch('/api/articles/1/comments').expect(405));
    it('will return 405 if any methods are used that are not aloud', () => request.delete('/api/articles/1/comments').expect(405));
  });
  describe('/articles/:article_id/comments/:comment_id', () => {
    ...
    it('PATCH status:400 doesnt insert a number for votes', () => request
      ...
      .send({ inc_votes: 'five' })
      .expect(400));
    it('PATCH status:404 doesnt insert a correct article:id that represents the comment:id for votes', () => request
      .patch('/api/articles/3/comments/7')
      .send({ inc_votes: 7 })
      .expect(404));
    it('PATCH status:404 doesnt insert an existing comment:id for votes', () => request
      .patch('/api/articles/1/comments/74789')
      .send({ inc_votes: 7 })
      .expect(404));
    // it("delete status:204 removes the comment specified in the params", () =>
    //   request
    //     .delete("/api/articles/1/comments/4")
    //     .expect(204)
    //     .then(() => request.get("/api/articles/1/comments").expect(404)));
